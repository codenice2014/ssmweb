	...
	<div class="addEdit-block" :style='{"padding":"10px 30px 30px","background":"url(http://codegen.caihongy.cn/20230228/47752d6be3a94e8892a83ec2a70c8443.png)"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="陪诊费" prop="peizhenfei">
					<el-input v-model="ruleForm.peizhenfei" placeholder="陪诊费" clearable  :readonly="ro.peizhenfei"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="陪诊费" prop="peizhenfei">
					<el-input v-model="ruleForm.peizhenfei" placeholder="陪诊费" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="预约原因" prop="yuyueyuanyin">
					<editor 
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.yuyueyuanyin" label="预约原因" prop="yuyueyuanyin">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.yuyueyuanyin"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='peizhenfei'){
							this.ruleForm.peizhenfei = obj[o];
							this.ro.peizhenfei = true;
							continue;
						}
						if(o=='yuyueshijian'){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.yuyueyuanyin = this.ruleForm.yuyueyuanyin.replace(reg,'../../../ssmgo829/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yuyuepeizhenyuan/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yuyuepeizhenyuanCrossAddOrUpdateFlag = false;
						 this.parent.search();
