		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'" label="科室" prop="keshi">
					<el-select :disabled="ro.keshi" @change="keshiChange" v-model="ruleForm.keshi" placeholder="请选择科室">
						<el-option
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.keshi" label="科室" prop="keshi">
